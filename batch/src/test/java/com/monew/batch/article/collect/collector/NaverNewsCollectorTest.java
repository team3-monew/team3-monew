...
//    assertThat(result.articles().get(0).summary()).isEqualTo("Spring <Boot> 요약");
//    server.verify();
//  }
//
//  @Test
...
//            itemJson("URL 없음", null, null, "요약"),
//            itemJson("URL 공백", " ", "https://naver.example.com/blank", "요약"),
//            itemJson("정상 URL", null, "https://naver.example.com/java", "요약")
//        ), MediaType.APPLICATION_JSON));
//
//    // when
//    KeywordCollectResultDto result = collector.collectByKeywordResult("java", 10);
